...
import { ParkingOverview }from "../user/ParkingOverview"
...
export const UserSidebar = () => {
  ...
  return (  
    <>
      <UserNavbar sidebarSetter={ClickSidebar} />
      {
          sidebarToggle==true && ( 
      <>
            ...
            <ul className="nav sidebar-menu flex-column" role="menu" data-accordion="false">
              <li className="nav-item menu-open">
                <Link to="#" className="nav-link active">
                  ...
                  <p>Dashboard <i onClick={()=>{setisDashboardOpen(!isDashboardOpen)}} className={`bi nav-arrow ${isDashboardOpen ?"bi-chevron-right" :"bi-chevron-up"} `} /></p>
                </Link>
              ...
              <li className="nav-item menu-open">
                <Link to="#" className="nav-link active">
                  ...
                  <p>Parking Insights <i onClick={()=>{setisInsightsOpen(!isInsightsOpen)}} className={`bi nav-arrow ${isInsightsOpen ?"bi-chevron-right" :"bi-chevron-up  "} `} /></p>
                </Link>
              ...
              <li className="nav-item menu-open">
                <Link to="#" className="nav-link">
                  ...
                  <p>User Profile<i onClick={()=>{setisUserProfileOpen(!isUserProfileOpen)}} className={`bi nav-arrow ${isUserProfileOpen ?"bi-chevron-right" :"bi-chevron-up  "} `} /></p>
                </Link>
              {
                isUserProfileOpen && (
                <ul className="nav nav-treeview">
              ...
              <li className="nav-item menu-open">
                <Link to="#" className="nav-link">
                  ...
                  <p>Support & FAQs</p><i onClick={()=>{setisSupportOpen(!isSupportOpen)}} className={`bi nav-arrow ${ isSupportOpen ?"bi-chevron-right" :"bi-chevron-up  "} `} />
                </Link>
                {
                  isSupportOpen && (
                <ul className="nav nav-treeview">
