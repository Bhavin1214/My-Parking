...
export const Signup = () => {
  ...
  return (
    <div className="wrapper bg-light min-vh-100 d-flex flex-column">
      ...
      <div className="d-flex justify-content-center align-items-center flex-grow-1" style={{
          ...
          <div className="card shadow-lg rounded-lg">
            ...
            <form onSubmit={handleSubmit(submitHandler)} className="p-4">
              <div className="form-group">
                ...
                <input type="text" className="form-control" placeholder="Enter full name" {...register('name', validationSchma.nameValidator)} />
                <span className="text-danger"> {errors.name?.message}</span>
              </div>
              <div className="form-group">
                <label>Age</label>
                <input type="number" className="form-control" placeholder="Enter age" {...register('age', validationSchma.ageValidator)} />
