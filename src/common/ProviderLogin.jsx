        ...
        <div className="bg-gray-100 overflow-hidden">
            ...
            <nav className="bg-gray-900 text-white fixed top-0 w-full shadow-lg py-3 px-6 z-20">
                ...
                {menuOpen && (
                    <div className="md:hidden bg-gray-800 text-white py-4 px-6 absolute top-16 w-full flex flex-col space-y-4">
                        ...
                        <Link className="bg-white text-gray-900 px-4 py-2 rounded-lg shadow-md hover:bg-gray-300 transition duration-300 text-center" to="/provider-login" onClick={() => setMenuOpen(false)}>Login</Link>
                        <Link className="bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-blue-700 transition duration-300 text-center" to="/provider-signup" onClick={() => setMenuOpen(false)}>Register</Link>
                    </div>
                )}
            </nav>
            ...
            <div className="flex items-center justify-center mt-16 pt-20 pb-20 bg-gray-900">
                <div className="w-80 p-5 bg-gray-800 text-white rounded-xl shadow-lg">
                    <h2 className="text-center text-xl font-semibold">Provider Login</h2>
